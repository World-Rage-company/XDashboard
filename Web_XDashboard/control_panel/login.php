...
<head>
    ...
    <title>Login | XCPL</title>
    <link rel="icon" href="../accounts/assets/images/xlogo.png" type="image/x-icon">
    <link rel="stylesheet" href="../accounts/assets/css/style_login.css">
</head>
<body>
